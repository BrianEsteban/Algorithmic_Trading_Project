...
Original file is located at
    https://colab.research.google.com/drive/15bIig-xdXjhbd3D1Q8cc0aZ2ekSn6MgH
"""
...
def make_pipeline():
    ...
    eps_growth = Fundamentals.diluted_cont_eps_growth.latest
    ...
    payable = Fundamentals.accounts_payable.latest
    depreciation = Fundamentals.accumulated_depreciation.latest
    value_per_share = Fundamentals.book_value_per_share.latest
    capital_per_share = Fundamentals.working_capital_per_share.latest
    ...
    eps_growth_winsorized = eps_growth.winsorize(min_percentile=0.05,max_percentile=0.95)
    size_score_winsorized = size_score.winsorize(min_percentile=0.05,max_percentile=0.95)
    value_score_winsorized = value_score.winsorize(min_percentile=0.05,max_percentile=0.95)
    margin_winsorized = margin.winsorize(min_percentile=0.05, max_percentile=0.95)
    payable_winsorized = payable.winsorize(min_percentile=0.05,max_percentile=0.95)
    depreciation_winsorized = depreciation.winsorize(min_percentile=0.05,max_percentile=0.95)
    value_per_share_winsorized = value_per_share.winsorize(min_percentile=0.05,max_percentile=0.95)
    capital_per_share_winsorized = capital_per_share.winsorize(min_percentile=0.05,max_percentile=0.95)
    ...
    combined_factor = (
        ...
        0.50 *eps_growth_winsorized.zscore() +
        size_score_winsorized.zscore() +
        -0.50*value_score_winsorized.zscore() +
        0.5 * margin_winsorized.zscore() -
        1/payable_winsorized.zscore() +
        depreciation_winsorized.zscore() +
        value_per_share_winsorized.zscore() -
        capital_per_share_winsorized.zscore() 
    )
